...
public class Zotac extends JFrame {
    ...
    Zotac(){
           ...
           name = new JLabel();
           name.setText("Name :      ZOTAC GAMING GeForce GTX 1660 SUPER 6GB GDDR6 Twin Fan Graphics Card");
           name.setFont(f);
           c.add(name);
           name.setBounds(35, 10 , 800, 50);
                   
           price = new JLabel();
           price.setText("Price :     	35,500 TK");
           price.setFont(f);
           c.add(price);
